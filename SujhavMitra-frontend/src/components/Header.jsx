      ...
      <div className="wrapper">
        <div className="mx-auto flex justify-between items-center px-4">
          ...
          <div className="flex gap-4 items-center">
            ...
            <div className="relative" ref={wlRef}>
              ...
              >
                ...
                <svg 
                  ...
                  viewBox="0 0 24 24" 
                  fill="currentColor" 
                  className={`h-6 w-6 ${wlOpen ? 'text-rose-600' : 'text-gray-700'} hover:text-rose-600 transition-colors`}
                >
              ...
              {wlOpen && (
                <div className="absolute right-0 mt-2 w-72 max-w-[calc(100vw-1rem)] rounded-xl border bg-white p-3 shadow-xl z-50">
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <Link to="/profile" className="text-xs text-cyan-700 hover:underline" onClick={() => setWlOpen(false)}>
                      View all
                    </Link>
                  </div>
                  {list.length === 0 ? (
                      ...
                      {list.slice(0, 6).map((it) => (
                        <li key={`${it.kind}-${it.key}`} className="group">
                          <Link
                            ...
                            className="block px-3 py-2 rounded-lg transition-colors duration-200 hover:bg-gray-50 group-hover:bg-gray-50"
            ...
            {user ? (
              <>
                <span className="text-gray-700 text-sm">Hi, {(() => {
