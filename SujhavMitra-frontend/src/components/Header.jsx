          ...
          <div className="flex gap-4 items-center">
            ...
            {user && user.role_id === 3 && (
              <div className="relative" ref={wlRef}>
                ...
                >
                  ...
                  {count > 0 && (
                    <span className="absolute -right-1 -top-1 inline-flex items-center justify-center rounded-full bg-[#837fcb] px-1.5 py-0.5 text-[10px] font-bold text-white">
                      {count}
                    </span>
                  )}
                </button>
            ...
            {user ? (
              <>
                <button
                  onClick={logout}
                  className="bg-[#837fcb] text-white px-3 py-1 rounded hover:bg-red-600 text-sm transition-colors"
                >
                  Logout
                </button>
              </>
